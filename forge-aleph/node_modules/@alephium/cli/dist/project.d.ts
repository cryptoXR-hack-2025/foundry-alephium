...
export declare class Project {
    ...
    private constructor();
    static checkCompilerWarnings(contracts: Map<string, Compiled<Contract>>, scripts: Map<string, Compiled<Script>>, globalWarnings: string[], changedContracts: string[], forceRecompile: boolean, errorOnWarnings: boolean): void;
    contract(name: string): Contract;
    script(name: string): Script;
    static loadStructs(artifactsRootDir: string): Promise<Struct[]>;
    ...
    private static getDeployedContracts;
    private static filterChangedContracts;
    ...
    static compile(compilerOptionsPartial?: Partial<CompilerOptions>, projectRootDir?: string, contractsRootDir?: string, artifactsRootDir?: string, defaultFullNodeVersion?: string | undefined, forceRecompile?: boolean, skipRecompileIfDeployedOnMainnet?: boolean, skipRecompileContracts?: string[], mainnetNodeUrl?: string | undefined): Promise<Project>;
}
export {};
